# E2E tests: Ubuntu, JDK8, Chrome, Firefox and Xvfb in Docker [![Build Status](https://travis-ci.org/daggerok/e2e-ubuntu-jdk8-xvfb.svg?branch=all)](https://travis-ci.org/daggerok/e2e-ubuntu-jdk8-xvfb)
